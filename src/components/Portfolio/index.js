      ...
      <Grid container spacing={1}>
        ...
        className="project1">
           <Link display="flex" justifyContent="center" href="https://young-shelf-43673.herokuapp.com/" target="_blank" rel="noreferrer">Supper Snacks</Link>
            ...
            <Container fluid className="prj1">
              ...
              <Link display="flex" justifyContent="center" href="https://github.com/Samantha-Ruth/supper-snacks" target="_blank" rel="noreferrer">GitHub</Link>
            </Container>
        </Grid>
        <Grid xs={5} lg={5} className="project1">
            ...
            <Container fluid className="prj2">
              ...
              <Link display="flex" justifyContent="center" href="https://github.com/Samantha-Ruth/Group-Covid-Project" target="_blank" rel="noreferrer">GitHub</Link>
            </Container>
        </Grid>
        <Grid xs={5} lg={5} className="project1">
          <Link display="flex" justifyContent="center" href="https://quiet-river-83898.herokuapp.com" target="_blank" rel="noreferrer">Healthcare Hero</Link>
            ...
            <Container fluid className="prj1">
              ...
              <Link display="flex" justifyContent="center" href="https://github.com/Samantha-Ruth/Healthcare-Hero" target="_blank" rel="noreferrer">GitHub</Link>
            </Container>
        </Grid>
        <Grid xs={5} lg={5} className="project1">
          <Link display="flex" justifyContent="center" href="https://whispering-escarpment-95024.herokuapp.com" target="_blank" rel="noreferrer">Budget Tracker</Link>
              ...
              <Link display="flex" justifyContent="center" href="https://github.com/Samantha-Ruth/Budget-Tracker" target="_blank" rel="noreferrer">GitHub</Link>
            </Container>
        </Grid>
      </Grid>
    </Box>
