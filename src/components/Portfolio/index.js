    ...
    <Box sx={{ flexGrow: 1 }}>
      <Grid container spacing={1}>
          ...
          <Grid display="flex" justifyContent="center" alignItems="center">
           ...
           <IconButton size="large" aria-label="delete" href="https://github.com/Samantha-Ruth/supper-snacks" target="_blank" rel="noreferrer">
            ...
            <img className="image" src={recipe}   style={{ width: "90%" }} alt="profile" />
              <Grid display="flex" justifyContent="center" className="my-1">Compose a meal with what's left in your fridge!</Grid>
        </Grid>
        ...
        <Grid display="flex" justifyContent="center" alignItems="center">
            ...
            <IconButton size="large" aria-label="delete" href="https://github.com/Samantha-Ruth/Group-Covid-Project" target="_blank" rel="noreferrer">
                <GitHubIcon  />
            </IconButton>
            </Grid >
            <img src={COVID} className="px-1 mx-2" alt="profile" />
              <Grid display="flex" justifyContent="center" className="my-1">Research COVID-19 data per country.</Grid>
        </Grid>
        <Grid xs={5} lg={5} className="project1">
        <Grid display="flex" justifyContent="center" alignItems="center">
          ...
          <IconButton size="large" aria-label="delete" href="https://github.com/Samantha-Ruth/healthcare-hero" target="_blank" rel="noreferrer">
            ...
            <img src={healthcare_Hero} className="px-1 mx-2" alt="profile" />
              <Grid display="flex" justifyContent="center" className="my-1">Web application to help patients compare the cost of a service across different medical providers.</Grid>
        </Grid>
        <Grid xs={5} lg={5} className="project1">
        <Grid display="flex" justifyContent="center" alignItems="center">
          ...
          <IconButton size="large" aria-label="delete" href="https://github.com/Samantha-Ruth/Budget-Tracker" target="_blank" rel="noreferrer">
                <GitHubIcon  />
            </IconButton>
            </Grid>
              <img
                ...
                className="px-1 mx-2" 
              />
              <Grid display="flex" justifyContent="center" className="my-1">Keep track of your finances!</Grid>
        </Grid>
      </Grid>
    </Box>
  );
